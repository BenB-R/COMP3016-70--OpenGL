...
// Constructor
Model::Model(std::string const& path, bool gamma, bool isLightSource) : gammaCorrection(gamma), isLightSource(isLightSource) {
    loadModel(path);
}
...
// loadMaterialTextures implementation
...
// TextureFromFile implementation
